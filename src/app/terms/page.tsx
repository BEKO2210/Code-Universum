  ...
  return (
    <>
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-[var(--cu-text-primary)] mb-8">Terms of Use</h1>

        <div className="prose-custom space-y-6 text-sm text-[var(--cu-text-secondary)] leading-relaxed">
